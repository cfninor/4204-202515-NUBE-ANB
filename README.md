...
| Documento                         | Descripción                                                                                                                                                                                  | Ruta                                                                                              |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| **Modelo de Componentes**       | Representación visual de los componentes de arquitectura de la aplicación.                                       | [`/docs/Entrega_2/diagrama_componentes.md`](./docs/Entrega_2/diagrama_componentes.md)             |
| **Modelo de Despliegue**    | Representación visual de la arquitectura de despliegue en nube.                                                          | [`/docs/Entrega_2/despliegue_y_documentacion.md`](./docs/Entrega_2/despliegue_y_documentacion.md) |
